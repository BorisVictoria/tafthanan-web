...
<div class="wrapper main">
    <div class="left">
        <article>
            ...
            <hr>
            <div class="setting-button-container">
                <button class="action-button pointer" id="btn-log-out"><h1 class="red">Log out</h1></button>
            </div>
        </article>
        ...
        <article>
            ...
            <form id="change-bio">
                ...
                <div class="content-writer">
                    ...
                    <div class="text-area" placeholder="New bio..." contenteditable="true">
